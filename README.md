...
- 3x Red followed by n Green Flashes : Error in Data Retention (Refresh Cycle). The Ram lost content below the guaranteed Refresh Time. For 16 and 18 Pin Types the Test uses 2ms for 20 Pin 4ms Refresh Time. 
