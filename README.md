...
| Automatic detection | automatically identifies the Type and check for reusability of broken parts |
---
...
| 32 K x 1 | 3732 <sup>2)</sup> | - | - | - | 2/4ms | 2.8sec |
| 32 K x 1 | 4532 <sup>2)</sup>| - | - | - | 2/4ms | 2.8sec |
| 64 K × 1 | 4164 | - | – | - | 2/4ms | 2.8sec |
...
<sup>2)</sup>if enabled in Firmware. Per default it is active after 4.2.3<br/>
