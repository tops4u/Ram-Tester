...
void sense41256_16Pin() {
  ...
  NOP;
  NOP;
  uint8_t a8_test = (PINC & 0x04) >> 2;
  CAS_HIGH16;
  RAS_HIGH16;

  if (a8_test == 0) {
    // A8 ist funktional -> 41256
    type = T_41256;
    return;
  }

  // A8 aliased -> könnte 4164 oder 4816 sein
  
  // --- SCHRITT 2: A7 Test (4164 vs 4816) ---
  // Write 0 in Row 0
  rasHandling_16Pin(0);
  PORTC &= ~0x02;  // DIN = LOW
  WE_LOW16;
  ...
  if (a7_test == 0) {
    // A7 ist funktional -> 4164
    type = T_4164;
  } else {
    // A7 ist aliased -> 4816/4516 (beide werden als T_4816 behandelt)
    type = T_4816;
  }
}
//=======================================================================================
