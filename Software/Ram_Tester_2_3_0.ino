...
struct RAM_Definition ramTypes[] = {
  ...
  { "41257  256Kx1-NM", 4, 2, 512, 512, 1, false, true, false, { 0, 0, 0, 0, 0, 0 }, 1940 },      // Never tested yet so we treat it as 41256
...
uint8_t
mix8(uint16_t col, uint16_t row) {
...
/* old macro can now wrap the fast helper if you prefer */
#define MIX8(c, r) mix8((c), (r))
    ...
    case 1:
      {
        ...
        u8x8.setFont(u8x8_font_7x14B_1x2_r);
        u8x8.drawString(0, 5, "AddrErr. Pin=");
