...
struct RAM_Definition ramTypes[] = {
  ...
  { ramType_4464, 1, 256, 256, 0, { 96, 0, 0, 0, 0, 0 }, 94 },
  ...
  { ramType_514256, 4, 512, 512, RAM_FLAG_SMALL_TYPE, { 62, 62, 62, 62, 30, 30 }, 30 },
  ...
  { ramType_4164_2ms, 1, 256, 256, RAM_FLAG_SMALL_TYPE, { 0, 0, 0, 0, 0, 0 }, 37 },
  { ramType_2114, 0, 0, 0, 0, { 0 }, 0 }                                             // 2114 SRAM: only .name used; other fields unused
};
