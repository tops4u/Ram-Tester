...
// - 514256 (256Kx4, 9 address lines, 8ms refresh)
// - 514258 (256Kx4 Static Column, 9 address lines, 8ms refresh)
// - 514400 (1Mx4, 10 address lines, 16ms refresh)
// - 514402 (1Mx4 Static Column, 10 address lines, 16ms refresh)
...
/**
 * Write random pattern and handle retention testing for a single row (514xxx)
 *
 * Only called for patterns 4-5 (pseudo-random). The checkerboard passes 0-1
 * are handled by checkerboardTest_20Pin() (bounded write->read window).
 *
...
/**
 * Verify random pattern in row using page mode read (514xxx)
 *
 * Only called for patterns 4-5 (pseudo-random) during retention testing.
 * The checkerboard passes 0-1 are verified by checkerboardTest_20Pin().
 *
 * @param patNr Pattern number being verified (4-5 only)
...
/**
 * Write random test pattern to entire row using page mode (4116/4027)
 *
 * Performs page mode write for 1-bit data bus. Only used for the pseudo-random
 * patterns (the checkerboard passes run through checkerRow_4116).
 *
...
/**
 * Verify random test pattern in row using page mode read (4116/4027)
 *
