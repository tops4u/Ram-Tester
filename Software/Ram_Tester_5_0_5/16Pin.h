...
//=======================================================================================
// 16-PIN LOOKUP TABLES
//=======================================================================================
// Address translation uses SPLIT lookup tables (lut_16_low_* 32 entries +
// lut_16_high_* 16 entries, defined file-locally in 16Pin.cpp) instead of a
// combined 512-entry table — saves ~1.4 KB flash.
...
// Write/Read functions: writeRow_16Pin / refreshRow_16Pin / checkRow_16Pin
// (prototypes at the top of this header; random patterns 4-5 + retention)
