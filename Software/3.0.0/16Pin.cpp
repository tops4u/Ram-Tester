...
//=======================================================================================
// EXTENDED DRAM DETECTION FOR T_4816 SUPPORT
//=======================================================================================

/**
 * Extended Chip-Detection für 16-Pin DRAMs
 * Distinction between 4164 (64Kx1), 41256 (256Kx1) und 4816 (16Kx1, no A7)
 */
void sense41256_16Pin() {
  CAS_HIGH16;

  // --- STEP 1: A8 Test (4164 vs 41256/4816) ---
  // Write 0 in Row 0
  rasHandling_16Pin(0);
  PORTC &= ~0x02;  // DIN = LOW
  WE_LOW16;
  ...
  if (a7_test == 1) {
    // A7 is aliased -> could be 4164 or 4816
    // --- STEP 2: A6 Test (4164 vs 4816) ---
    // Write 0 in Row 0
    rasHandling_16Pin(0);
    PORTC &= ~0x02;  // DIN = LOW
    WE_LOW16;
    ...
    if (a6_test == 1) {
      // A6 is aliased -> 4816 (no A6 Pin)
      type = T_4816;
    } else {
      // A6 functional, but A7 aliased -> 4164
      type = T_4164;
    }
  } else {
    // A7 functional -> 41256
...
//=======================================================================================
//  ADDRESS TESTING WITH T_4816 SUPPORT
//=======================================================================================
